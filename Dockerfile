# Dockerfile para Main Service (Config Server + Eureka Server)
# Microsserviço central responsável pela configuração e service discovery
...
# Expor a porta 8888 (Config Server + Eureka Server)
EXPOSE 8888
